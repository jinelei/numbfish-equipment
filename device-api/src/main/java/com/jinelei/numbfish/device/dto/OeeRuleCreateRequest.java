...
@Schema(description = "Oee规则创建请求对象")
public class OeeRuleCreateRequest implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        OeeRuleCreateRequest that = (OeeRuleCreateRequest) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(enabled, oeeRule, oeeRuleRender, oeeRuleEdit, availabilityRule, availabilityRuleRender, availabilityRuleEdit, performanceRule, performanceRuleRender, performanceRuleEdit, qualityRule, qualityRuleRender, qualityRuleEdit);
    }

    @Override
    public String toString() {
        return "OeeRuleCreateRequest{" +
                "enabled=" + enabled +
                ", oeeRule='" + oeeRule + '\'' +
