...
public class AlarmRuleResponse implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        AlarmRuleResponse that = (AlarmRuleResponse) o;
        return Objects.equals(id, that.id) && Objects.equals(code, that.code) && Objects.equals(name, that.name) && Objects.equals(alarmRule, that.alarmRule) && Objects.equals(alarmRuleRender, that.alarmRuleRender) && Objects.equals(alarmRuleEdit, that.alarmRuleEdit) && Objects.equals(remark, that.remark) && Objects.equals(enabled, that.enabled) && level == that.level;
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, code, name, alarmRule, alarmRuleRender, alarmRuleEdit, remark, enabled, level);
    }
