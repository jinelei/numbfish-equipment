...
public class DeviceQueryRequest implements Serializable {
    ...
    public void setDeviceState(RunningState runningState) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DeviceQueryRequest other = (DeviceQueryRequest) obj;
        if (id == null) {
            if (other.id != null)
                return false;
    ...
    public String toString() {
        return "DeviceQueryRequest [id=" + id + ", ids=" + ids + ", code=" + code + ", name="
                + name + ", deviceType=" + deviceType + ", runningState=" + runningState + ", remark=" + remark
                + "]";
    }
